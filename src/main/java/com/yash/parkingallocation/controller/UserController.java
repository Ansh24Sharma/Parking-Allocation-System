...
import com.yash.parkingallocation.command.UserCommand;
import com.yash.parkingallocation.command.LoginCommand;
...
import com.yash.parkingallocation.service.UserService;
...
public class UserController {
    ...
    public String landing(Model m) {
        return "landing"; //JSP - /WEB-INF/view/index.jsp
    }
    ...
    public String registerUser(@ModelAttribute("command") UserCommand cmd, Model m) {
        try {
            ...
            activityService.logActivity("New User", "User registered with username: " + user.getLoginName());
